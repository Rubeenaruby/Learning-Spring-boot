...
The @Controller annotation in Spring is used to define a controller class. A controller in Spring is responsible for handling incoming web requests, 
processing them, and returning a response, typically in the form of a view (like a JSP page).
...
public class UserController {
    ...
    public String userSettings(Model model) {
        model.addAttribute("setting", "Dark Mode");
        return "settings";
    }
}
...
public class OrderController {
    ...
    public String getOrder(@PathVariable("id") int orderId, @RequestParam(value = "details", required = false) String details) {
        if (details != null) {
